...
function card_creator(movie,array_comparison){
    let card = ``
    if (array_comparison.includes(movie.id)){
        card = `  
        <article class="flex-shrink-0 w-[300px] border-gray-200 rounded-lg shadow dark:bg-[#222222] dark:border-[#222222] transition ease-in-out  hover:transform hover:scale-110">
            ...
            <div data-id="${movie.id}" class="h-12 w-12 bg-violet-700 rounded-md flex flex-row items-center justify-center">
            <svg data-id="${movie.id}"  class="pointer-events-none" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white" class="bi bi-heart-fill" viewBox="0 0 16 16">
...
`}
        ...
        <article class="flex-shrink-0 w-[300px] border-gray-200 rounded-lg shadow dark:bg-[#222222] dark:border-[#222222] transition ease-in-out  hover:transform hover:scale-110">
            ...
            <div class="flex flex-row content-center items-center place-content-evenly gap-8 ">
            <div data-id="${movie.id}" class="h-12 w-12 bg-gray-950	 rounded-md flex flex-row items-center justify-center">
            <svg data-id="${movie.id}"  class="pointer-events-none" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white" class="bi bi-heart-fill" viewBox="0 0 16 16">
      <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"/>
      </svg>
      </div>
